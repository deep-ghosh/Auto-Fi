...
exports.CeloWalletApi = void 0;
class CeloWalletApi {
    constructor() {
        this.name = 'celoWallet';
        this.displayName = 'Celo Wallet';
        this.documentationUrl = 'https://docs.celo.org/';
        this.properties = [
            {
...
exports.CeloWalletApi = CeloWalletApi;
//# sourceMappingURL=CeloWallet.credentials.js.map