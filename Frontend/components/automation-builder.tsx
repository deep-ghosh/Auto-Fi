...
import type { AutomationRequest } from "@/lib/api-client"
...
const automationSchema = z.object({
  ...
  conditions: z.object({
    ...
    balanceCondition: z.string().optional(),
  }).optional(),
})
  ...
  async function onSubmit(data: AutomationFormData) {
    ...
    try {
      if (aiMode && aiPrompt) {
        ...
        await createAutomationWithAI(aiPrompt, {
        ...
        await addAutomation(automationRequest)
      }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="e.g., Send 10 CELO to 0x123... every Monday at 9 AM when CELO price is above $0.5"
